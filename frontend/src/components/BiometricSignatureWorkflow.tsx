...
const BiometricSignatureWorkflow = ({
  ...
  const [step, setStep] = useState<
    'intro' | 'capture' | 'processing' | 'success' | 'error'
  >('intro');
  ...
  const handleBiometricSuccess = async (
    ...
    try {
      ...
      const response = await api.post(
        `/api/signatures/${documentId}/biometric`,
        payload,
      );
      ...
      setError(
        err?.response?.data?.message || 'Error al procesar firma biométrica',
      );
      setStep('error');
    } finally {
        ...
        return (
          <div className='p-6'>
            <h3 className='mb-4 text-lg font-medium text-gray-900'>
              Firma biométrica de documento
            </h3>
            <p className='mb-4 text-gray-600'>
              Está a punto de firmar{' '}
              <span className='font-medium'>{documentTitle}</span> utilizando
            ...
            {!hasBiometrics ? (
                ...
                <div className='flex'>
                  ...
                  <div className='ml-3'>
                    ...
                    <div className='mt-2 text-sm text-yellow-700'>
                      <p>
                        Para firmar con biometría, primero debe registrar sus
                        datos biométricos.
                      </p>
                    </div>
                  </div>
              ...
              <p className='mb-4 text-sm text-gray-500'>
                La firma biométrica proporciona mayor seguridad y validez legal
                al documento al verificar su identidad mediante reconocimiento
                facial.
              </p>
            )}
              ...
              <div className='flex'>
                ...
                <div className='ml-3'>
                  <h3 className='text-sm font-medium text-red-800'>
                    Error en la firma biométrica
                  </h3>
                  <div className='mt-2 text-sm text-red-700'>
                    <p>
                      {error ||
                        'Se produjo un error al procesar la firma biométrica.'}
                    </p>
                  </div>
                </div>
              </div>
