...
const CustomSignatureSeal = ({
  name,
  date,
  reason,
  onSave,
  onCancel,
}: CustomSignatureSealProps) => {
  ...
  const handleContentChange = (
    property: keyof SealData['content'],
  ...
  const handleLogoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 500000) {
      // 500KB máximo
      warning(
        'El logo es demasiado grande. Máximo 500KB permitido.',
        'pSDK-300',
      );
    ...
    if (!file.type.startsWith('image/')) {
      warning('Solo se permiten archivos de imagen.', 'pSDK-300');
      return;
    }
      ...
      <div className='grid grid-cols-1 gap-6 mb-6 md:grid-cols-2'>
        ...
        <div className='space-y-4'>
            ...
            <div className='flex space-x-2'>
              <button
                ...
                className={`p-2 border rounded ${
                  sealData.style.shape === 'rectangle'
          ...
          <div>
            ...
            <div className='flex items-center'>
              <input
                type='color'
                value={sealData.style.backgroundColor
                  .replace('rgba(', '')
                  .replace(')', '')
                  .split(',')
                  .slice(0, 3)
              ...
              <input
                ...
                value={
                  parseInt(
                    sealData.style.backgroundColor
                      .replace('rgba(', '')
                      .replace(')', '')
                      .split(',')[3]
                      .trim(),
                ...
                onChange={(e) => {
                  ...
                  const rgba = sealData.style.backgroundColor
                    .replace('rgba(', '')
                    .replace(')', '')
                    .split(',');
          ...
          <div className='space-y-2'>
            <div className='flex items-center'>
              <input
                ...
                onChange={(e) =>
                  handleContentChange('showName', e.target.checked)
                }
            ...
            {reason && (
              <div className='flex items-center'>
                <input
                  ...
                  onChange={(e) =>
                    handleContentChange('showReason', e.target.checked)
                  }
                  className='w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500'
                />
                <label
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleContentChange('customText', e.target.value)
                }
        ...
        <div>
          ...
          <div className='mt-4 text-xs text-gray-500'>
            Esta es una vista previa aproximada. El aspecto final puede variar
            ligeramente.
          </div>
        </div>
      </div>
