...
const Dashboard = () => {
  ...
  const [contentSearchResults, setContentSearchResults] = useState<DocumentType[] | null>(null);
  ...
  const DocumentCard = ({ document }: { document: DocumentType }) => (
    <div className="overflow-hidden transition-shadow duration-300 bg-white rounded-lg shadow hover:shadow-md">
      ...
      <div className="p-4">
        <h3 className="mb-1 text-lg font-medium text-gray-900 truncate">{document.title}</h3>
        {document.description && (
          <p className="mb-2 text-sm text-gray-500 line-clamp-2">{document.description}</p>
        )}
      ...
      <div className="mt-8 overflow-hidden transition-shadow duration-300 bg-white rounded-lg shadow hover:shadow-md">
        ...
        <ul className="divide-y divide-gray-200">
          {sharedDocuments.slice(0, 3).map((doc) => (
            <li key={doc.id} className="px-4 py-4 transition-colors duration-200 hover:bg-gray-50">
    ...
    <div className="px-4 py-8 pt-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="mb-8 md:flex md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4 md:mt-0 md:ml-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2 -ml-1 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2 -ml-1" viewBox="0 0 20 20" fill="currentColor">
          ...
          {isLoading ? (
            <div className="flex items-center justify-center p-12">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="mt-4 text-lg font-medium text-gray-700">Cargando documentos...</p>
              </div>
            </div>
          ) : errorMessage ? (
          ...
          {contentSearchResults && (
            <div className="mb-6">
              <div className="overflow-hidden bg-white rounded-lg shadow">
                <div className="px-4 py-5 border-b border-gray-200 sm:px-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-medium leading-6 text-gray-900">Resultados de búsqueda</h3>
                    <button
                      type="button"
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-75">
              <div className="w-full max-w-lg p-8 bg-white rounded-lg shadow-xl">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-medium text-gray-900">Búsqueda por contenido</h3>
                  <button
                    type="button"
